...
{
    public class QrCodeModule : Module
    {
        public ObjectId NextModuleId { get; set; }
        public string Text { get; set; }

        public QrCodeModule(ObjectId id, string objective, string text, ObjectId nextModuleId)
            : base(id, objective)
        {
            Text = text;
        ...
        public override ResponseEventCollection ProcessEvent(TrackerNodeMemento? memento, RequestEvent requestEvent)
            ...
            ? new ResponseEventCollection(
                    ...
                    new List<IResponseEvent>
                    {
                        ...
                        new ExperienceResponseEvent((long)(150 * (2 + new Random().NextDouble())))
                    })
            : new ResponseEventCollection(
                    memento,
                    new List<IResponseEvent>
